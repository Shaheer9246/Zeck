		...
		<>
			{chrome === "page" ? (
				<PageHeader
					...
					description="Connect messaging platforms so you can chat with Zeck anywhere. Click on a channel name to view or edit its configuration."
					meta={
				...
				<div className="mb-4 flex items-center justify-between gap-3">
					<p className="text-sm text-muted-foreground">
						Connect messaging platforms so you can chat with Zeck anywhere.
