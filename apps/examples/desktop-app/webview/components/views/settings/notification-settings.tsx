...
> = {
	taskCompletion: {
		...
		description: "When Zeck finishes a task or turn.",
	},
	approvalNeeded: {
	...
	questionAsked: {
		...
		description: "When Zeck needs an answer before continuing.",
	},
	sessionError: {
		label: "Session error",
			...
			<div className="flex items-center justify-between gap-5 max-[720px]:flex-col max-[720px]:items-stretch">
				<div className="flex flex-col gap-1">
					...
					<p className="text-sm text-muted-foreground">
						Notify only while the Zeck window is in the background. Clicking a
