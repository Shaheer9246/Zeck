...
export function publishProviderModels(_providerId: string, _models: ProviderModel[]): void {}

export function subscribeToProviderCatalogInvalidation(_listener: () => void): () => void {
	return () => {};
}
