...
export async function createSession(
	...
	const startedSession = await ctx.cline.get(result.sessionId);
	const effectiveWorkspaceRoot = startedSession?.workspaceRoot || context.workspaceRoot;
	const effectiveCwd = startedSession?.cwd || context.cwd;
